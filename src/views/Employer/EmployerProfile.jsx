...
export default function EmployerProfile() {
  ...
  return (
    <div className={"bg-blueGray-200"}>
            ...
            >
                                  ...
                                  if (phoneNumber) {
                                    ...
                                    if (
                                      ...
                                      Swal.fire({
                                        icon: "info",
                                        title:
                                          "Yetkili onayından sonra bilgileriniz güncellenecektir!",
              ...
              <div className={"flex flex-wrap mt-2"}>
                <div
                  ...
                  style={{ marginLeft: "56%" }}
                >
                  <div className="py-2 px-2 sm:mt-0"></div>
                </div>
              </div>
      ...
      <div className={"bg-blueGray-200"}>
        <h3 className="text-4xl mb-2 font-semibold leading-normal text-blueGray-800 text-center">
          <i className="fas fa-briefcase"></i> İlanlarım
        </h3>
        ...
        <div
          className={
            "relative flex flex-col min-w-0 break-words shadow-lg text-white rounded-lg bg-blueGray-800 mx-auto"
          }
                  ...
                  .map((jobAdvert, index) => (
                    ...
                    >
                      ...
                      <td className="border-b border-indigo-400 px-2 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-3">
                        {jobAdvert.confirmed ? (
                          <span style={{ color: "#5edb5e" }}>Onaylandı</span>
                        ) : (
                      ...
                      <td className="border-b border-indigo-400 px-4 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-3">
                        <input
                          ...
                          onClick={() =>
                            jobAdvert.active
                              ? employerService
                                  .deactiveJobAdvert(false, jobAdvert.id)
                                  .then(() => {
                                    getJobAdverts();
                                  })
                              : employerService
                                  .deactiveJobAdvert(true, jobAdvert.id)
                                  .then(() => {
                                    getJobAdverts();
                                  })
                          }
                      ...
                      <td className="border-b border-indigo-400 align-middle border-l-0 border-r-0 whitespace-nowrap py-3">
                        <JobAdvertDropdown
                          deleteJobAdvert={() => deleteJobAdvert(jobAdvert.id)}
                        />
                      </td>
                    </tr>
                  ))}
