...
export default function Index() {
  return (
    <div className={"bg-blueGray-200"}>
        ...
        <div className="container mx-auto items-center flex flex-wrap ">
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-12 ">
            <div className="pt-32 sm:pt-0">
              ...
              <br />
              <h2
                className="font-semibold text-center text-4xl text-blueGray-600"
                style={{ marginTop: -90 }}
              >
                İnsan Kaynakları Yönetim Sistemi
              </h2>
              <p className="mt-4 text-lg leading-relaxed text-center text-blueGray-500 mb-4">
                Kurumlara ait tüm iş ilanları ve başvuruları tek sayfada...
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        className="pt-24 relative bg-blueGray-200"
              ...
              <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg bg-lightBlue-900">
                ...
                <blockquote className="relative p-8 mb-4">
                  ...
                  <p className="text-md font-light mt-2 text-white">
                    Bir iş görüşmesinde iletişim kurma şeklin, işe alınma
                    şansını arttırabilir veya azaltabilir. İşte, bir iş
                    görüşmesi sırasında asla yapmaman gereken dört iletişim
                    hatası!
                  </p>
                </blockquote>
              </div>
                ...
                <div className="w-full md:w-6/12 px-1">
                  <div className="relative flex flex-col mt-1">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Sıkılmış veya stresli görünmemek için dik oturmalı elini
                        kolunu koyduğun yere dikkat etmelisin.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Elbette yaşadığın sorunlar olabilir, ancak şikayet
                        etmek, profesyonellikten uzak ve kindar görünmene neden
                        olur.
                      </p>
                    </div>
                  </div>
                ...
                <div className="w-full md:w-6/12 px-1">
                  <div className="relative flex flex-col min-w-0 mt-1">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Kendini daha nitelikli veya daha deneyimli göstermek
                        için asla doğru olmayan bilgiler vermemelisin.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <p className="mb-4 text-blueGray-500">
                        Soruyla ilgili olan en önemli noktalara değinerek, karşı
                        tarafa istediği cevabı net olarak vermelisin.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                ...
                <p className="mt-4 leading-relaxed text-blueGray-500">
                  CV hazırlamak isteyen kişilerin CV’nin nasıl hazırlanacağı
                  konusunda bilgi sahibi olması gerekir. Bu bilgi günümüzde
                  internet ortamından kolayca edinilebilir.CV hazırlarken
                  birtakım hususlara dikkat etmelidir.
                </p>
                <ul className="list-none mt-2">
                  <li className="py-2">
                    <div className="flex items-center">
                      <div>
                        <span className="font-bold inline-block px-2 uppercase rounded-full text-blueGray-500">
                          1 -
                        </span>
                      </div>
                      <div>
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            ...
            <p className="text leading-relaxed mt-4 mb-4 text-blueGray-500">
              Başta Engin DEMİROĞ hocamız olmak üzere teşekkürler...
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="w-full lg:w-12/12 px-4  -mt-24">
              <div className="flex flex-wrap">
                <div className="w-full lg:w-4/12 px-4">
                  <h5 className="font-semibold  text-center">BTK AKADEMİ</h5>
                  <a href={"https://www.btkakademi.gov.tr/portal/"}>
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 mb-6 break-words bg-white w-full shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={require("../assets/img/btkakademi.jpg").default}
                      />
                    </div>
                  </a>
                </div>
                  ...
                  <a href={"https://1milyonistihdam.hmb.gov.tr/"}>
                    <div className="hover:-mt-4 relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-lg ease-linear transition-all duration-150">
                      <img
                        alt="..."
                        className="align-middle border-none max-w-full h-auto rounded-lg"
                        src={require("../assets/img/1milyon.jpg").default}
                      />
                    </div>
                  </a>
                </div>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-blueGray-300">
                Bu proje açık kaynak olduğundan, herhangi biri herhangi bir amaç
                için projeyi görüntüleyebilir, kullanabilir, değiştirebilir ve
                dağıtabilir. Bu izinler açık kaynaklı bir lisans aracılığıyla
                uygulanmaktadır.
              </p>
