...
export default function AdminJobAdvertList() {
  ...
  return (
    <>
      ...
      <div
        className={
          "relative flex flex-col min-w-0 break-words shadow-lg text-white rounded-lg bg-blueGray-800"
        }
      >
                        ...
                        onClick={() =>
                          jobAdvert.confirmed
                            ? systemPersonelService
                                .approveJobAdvert(false, jobAdvert.id)
                                .then(() => {
                                  getJobAdverts();
                                })
                            : systemPersonelService
                                .approveJobAdvert(true, jobAdvert.id)
                                .then(() => {
                                  getJobAdverts();
                                })
                        }
