...
export default function AdminEmployerList({ color }) {
  ...
  return (
    <>
      ...
      <div
        className={
          "relative flex flex-col min-w-0 break-words mx-auto w-full mb-6 shadow-lg text-white rounded-lg bg-blueGray-800"
        }
        style={{ width: "60%" }}
      >
        <div className="block overflow-x-auto rounded-lg ">
          {/* Projects table */}
          <table className="items-center w-full mx-auto bg-transparent border-collapse tr-even:bg-red-200 rounded-lg">
            <thead>
              <tr>
                <th
                  className={
              ...
              {employers
                ...
                .map((employer, index) => (
                  ...
                  >
                    ...
                    <td className="border-b border-indigo-400 px-6 align-middle border-l-0 border-r-0 text-sm whitespace-nowrap py-3 text-center">
                      <EmployerDropdown
                        deleteEmployer={() => deleteEmployer(employer.id)}
                      />
                    </td>
                  </tr>
                ))}
