    ...
    <>
      ...
      >
        <div className="md:flex-col md:items-stretch md:min-h-full md:flex-nowrap px-0 flex flex-wrap items-center justify-between w-full mx-auto">
          {/* Brand */}
          <span className="md:block text-center md:pb-2 text-black mr-0 inline-block whitespace-nowrap text-sm uppercase font-bold p-4 px-0">
            Admin Paneli
          </span>
                ...
                >
                  <i
                    className={
                      ...
                      (window.location.href.indexOf("/admin/jobseekerList") !==
                      -1
                        ? "opacity-75"
                        : "text-blueGray-800")
                    }
                ...
                >
                  <i
                    className={
                      ...
                      (window.location.href.indexOf("/admin/employerList") !==
                      -1
                        ? "opacity-75"
                        : "text-blueGray-800")
                    }
                ...
                >
                  <i
                    className={
                      ...
                      (window.location.href.indexOf("/admin/jobAdvertList") !==
                      -1
                        ? "opacity-75"
                        : "text-blueGray-800")
                    }
