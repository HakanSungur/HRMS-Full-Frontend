            ...
            <nav
                ...
                <div className="container px-4 mx-auto flex flex-wrap items-center justify-center">
                    <div className="w-full relative flex justify-center lg:w-auto lg:static lg:block lg:justify-start">
                        <Link
                            className="text-black hover:text-lightBlue-600 text-sm font-bold leading-relaxed inline-block mr-2 py-2 whitespace-nowrap uppercase"
                            to="/"
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-6" fill="none"
                                 viewBox="0 0 24 24"
                                 stroke="currentColor">
