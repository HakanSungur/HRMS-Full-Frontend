...
export default class TechnologyService{
    ...
    getTechnologyByCvId(id){
        return axios.get(`http://localhost:8080/api/technologies/getTehnologyByCvId?cvId=${id}`)
    }
    ...
    async deleteTechnologyById(id) {
        return await axios.delete(`http://localhost:8080/api/technologies/deleteTechnologyById?id=${id}`)
    }
}