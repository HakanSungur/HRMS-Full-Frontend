...
export default class JobAdvertService{
    ...
    getActiveJobAdvertsSorted(isDesc){
        return axios.get(`http://localhost:8080/api/jobadverts/getActiveJobAdvertsSorted?isDesc=${isDesc}`)
    }
    ...
    getJobAdvertById(id){
        return axios.get(`http://localhost:8080/api/jobadverts/getJobAdvertById?jobAdvertId=${id}`)
    }
    ...
    getJobAdvertByCompanyName(companyName){
        return axios.get(`http://localhost:8080/api/jobadverts/getJobAdvertByCompanyName?companyName=${companyName}`)
    }

    getActiandConfirmedJobAdvertCount(){
        return axios.get(`http://localhost:8080/api/jobadverts/getActiveAndConfirmedJobAdvertCount`)
    }

    deleteJobAdvertById(id){
        return axios.delete(`http://localhost:8080/api/jobadverts/deleteJobAdvertById?jobAdvertId=${id}`)
    }
}